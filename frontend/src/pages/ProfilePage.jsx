        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-slate-50 p-5 rounded-xl border border-slate-100 flex flex-col gap-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm font-bold text-slate-500">Account Email</span>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Get notified 30 days before expiry</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between border-t border-slate-100 pt-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Delete all past chats with the Agent</p>
                </div>
              </div>
              <button onClick={handleClearHistory} className="text-red-500 text-sm font-semibold hover:underline">Clear</button>
            </div>
          </div>
        </div>
      </div>
